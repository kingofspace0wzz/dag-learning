...
from utils import *
from sorting_model import Sinkhorn_Net
...
parser.add_argument('--mode', type=str, default='dnn',
                    help='method')
...
def train_dnn(epoch, best_val_loss, ground_truth_G, lambda_A, c_A, optimizer):
    t = time.time()
    nll_train = []
    kl_train = []
    mse_train = []
